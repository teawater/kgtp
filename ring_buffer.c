/*
 * This file base on kernel/trace/ring_buffer.c
...
/* Sepcial config ------------------------------------------------ */
#ifndef __ARCH_SPIN_LOCK_UNLOCKED
 ...
 again:
	...
	if (likely(ts >= cpu_buffer->write_stamp)) {
		...
		if (unlikely(test_time_stamp(delta))) {
			...
			/* XXX: https://code.google.com/p/kgtp/issues/detail?id=73 */
#if 0
...
#error "gtp ring_buffer.c cannot be built when CONFIG_TRACING is ON"
#if 0
